...
//red, blue, green, yellow, orange, purple, blueish
let colores = ['#ff0000', '#0000ff', '#00e600', '#ffd11a', '#ff6600', '#993399', '#99bbff']
...
let funColor = (x, y) => 2/(1+exp(-sqrt(x*x+y*y)))-1;//sharp * ( log(sqrt(x * x + y * y)) / log(2) - floor(log(sqrt(x * x + y * y)) / log(2)) ) + 0.7;//sharp * (nContour * (PI - atan2(y, -x)) / (2 * PI) -  floor(nContour * (PI - atan2(y, -x)) / (2 * PI))) + 0.7;
